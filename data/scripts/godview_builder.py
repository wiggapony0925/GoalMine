...
def build_god_view(
    ...
    god_view = {
        ...
        "meta": {
            "agents_executed": {
                "logistics": logistics_data.get('status', 'OK') if logistics_data.get('branch') else "FALLBACK",
                "tactics": tactics_data.get('status', 'OK') if tactics_data.get('branch') else "FALLBACK",
                "market": market_data.get('status', 'OK') if market_data.get('branch') else "FALLBACK",
                "narrative_home": narrative_home.get('status', 'OK') if narrative_home.get('branch') else "FALLBACK",
                "narrative_away": narrative_away.get('status', 'OK') if narrative_away.get('branch') else "FALLBACK"
            },
    ...
    logger.debug(f"✅ God View built for {home_team} vs {away_team} (v{god_view['meta']['version']})")
