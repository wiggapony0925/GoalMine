...
async def generate_bet_recommendations(num_bets=3, user_phone=None, conversational_mode=False, user_question=None):
    """
    ...
    if conversational_mode and user_question:
        ...
        system_prompt = STRATEGIC_ADVISOR_PROMPT.format(god_view=json.dumps(intelligence_package, indent=2))
